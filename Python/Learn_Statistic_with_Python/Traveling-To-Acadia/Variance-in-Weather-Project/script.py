...
for i in range(1, 13):
  hour = london_data.loc[london_data['month'] == i]['Humidity']
  print('The mean humidity in month ' + str(i) + ' is ' + str(np.mean(hour)))
  print('The standard deviation of humidity in month ' + str(i) + ' is ' + str(np.std(hour)) + '\n')
